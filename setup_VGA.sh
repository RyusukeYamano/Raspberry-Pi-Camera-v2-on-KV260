...
sudo media-ctl -d /dev/media0 --set-v4l2 '"imx219 6-0010":0                   [fmt:SRGGB10_1X10/640x480]'


echo "### MIPI CSI2-Rx Subsystem subdev0 ###"
sudo media-ctl -d /dev/media0 --set-v4l2 '"80002000.mipi_csi2_rx_subsystem":0 [fmt:SRGGB10_1X10/640x480 field:none]'
sudo media-ctl -d /dev/media0 --set-v4l2 '"80002000.mipi_csi2_rx_subsystem":1 [fmt:SRGGB10_1X10/640x480 field:none]'


echo "### Demosaic IP subdev2 ###"
sudo media-ctl -d /dev/media0 --set-v4l2 '"a0010000.v_demosaic":0             [fmt:SRGGB10_1X10/640x480 field:none]'
sudo media-ctl -d /dev/media0 --set-v4l2 '"a0010000.v_demosaic":1             [fmt:RBG888_1X24/640x480 field:none]'


echo "### Gamma LUT IP subdev3 ###"
sudo media-ctl -d /dev/media0 --set-v4l2 'a0030000.v_gamma_lut":0             [fmt:RBG888_1X24/640x480 field:none]'
sudo media-ctl -d /dev/media0 --set-v4l2 'a0030000.v_gamma_lut":1             [fmt:RBG888_1X24/640x480 field:none]'
...
sudo media-ctl -d /dev/media0 --set-v4l2 '"a0040000.v_proc_ss_csc":0              [fmt:RBG888_1X24/640x480 field:none]'
sudo media-ctl -d /dev/media0 --set-v4l2 '"a0040000.v_proc_ss_csc":1              [fmt:RBG888_1X24/640x480 field:none]'
...
sudo media-ctl -d /dev/media0 --set-v4l2 '"a0080000.v_proc_ss_scaler":0              [fmt:RBG888_1X24/640x480 field:none]'
sudo media-ctl -d /dev/media0 --set-v4l2 '"a0080000.v_proc_ss_scaler":1              [fmt:RBG888_1X24/640x480 field:none]'
